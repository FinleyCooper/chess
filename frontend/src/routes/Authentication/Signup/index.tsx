                ...
                <div className="form-container">
                    <form className="form">
                        ...
                        <div className="credentials-container">
                            ...
                            <TextInput onBlur={this.validateInput} onChange={this.handleInputChange} valid={this.state.nameValid} error={this.state.nameError} label="Display Name" name="name" pattern="^\S.{1,28}\S$" autocomplete="off" />
